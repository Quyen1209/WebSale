...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthExceptionHandler authExceptionHandler) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth.antMatchers("/api/v1/products/**","/api/v1/orders/**","/api/v1/categories/**","/api/v1/accounts/**").permitAll().anyRequest().authenticated()
//                        .antMatchers("/api/v1/accounts/**")
//                        .hasAnyAuthority("ADMIN","EMPLOYEE","MANAGER")
//                        .antMatchers(HttpMethod.DELETE)
//                        .hasAnyAuthority("ADMIN")
//                        .antMatchers(HttpMethod.PUT, "/api/v1/accounts/**", "/api/v1/departments/**")
//                        .hasAnyAuthority("ADMIN")
//                        .antMatchers(HttpMethod.POST, "/api/v1/accounts/**", "/api/v1/departments/**")
//                        .hasAnyAuthority("ADMIN")
//                        .antMatchers("/api/v1/auth/login/**", "/api/v1/auth/register/**","/api/v1/departments","/api/v1/accounts")
//                        .permitAll()
